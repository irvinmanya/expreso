	...
	<div class="container">
		<div class="row">
			...
			<div class="col l3 m12 s12 rowFiltros lineLateralRight">
				...
				<?php if( have_rows('edizqflex-cont',77090) ): ?>
					<?php while ( have_rows('edizqflex-cont',77090) ) : the_row(); ?>
			...
			<div class="col l3 m12 s12">
				<?php if( have_rows('edderflex-cont',77090) ): ?>
					<?php while ( have_rows('edderflex-cont',77090) ) : the_row(); ?>
