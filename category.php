...
<?php if( have_rows('catflex-cont',76826) ): ?>
	<?php while ( have_rows('catflex-cont',76826) ) : the_row(); ?>
				...
				<div class="container notBox">
					<div class="row">
						<div class="col l8 m12 s12 rowRell rowResp">
							...
							<?php $secdestpriNposts = get_sub_field('secdestpri-nposts'); ?>

							<?php if( get_sub_field('secdestpri-opt') == 'descendente' ){ ?>
								<?php $args = array(
									'posts_per_page' => $secdestpriNposts,
									'cat' => get_query_var('cat'),
									'post__not_in' => $ids,
									'order' => 'DESC',
									'date_query' => array(
